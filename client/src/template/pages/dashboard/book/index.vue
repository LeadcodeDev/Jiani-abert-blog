		...
		<div class="px-8 mt-6">
			<div class="border px-4 py-3 w-full flex justify-between mb-4 shadow-sm rounded">
				...
				<div class="flex flex-row">
					<nuxt-link :to="'/dashboard/book/' + 1" class="bg-blue-600 text-white mx-1 px-2 py-1 rounded-md hover:bg-blue-500"><i class="icon-pencil text-red"></i></nuxt-link>
			...
			<div class="border px-4 py-3 w-full flex justify-between mb-4 shadow-sm rounded">
				...
				<p>HTML</p>
				<div class="flex flex-row">
					<nuxt-link :to="'/dashboard/book/' + 2" class="bg-blue-600 text-white mx-1 px-2 py-1 rounded-md hover:bg-blue-500"><i class="icon-pencil text-red"></i></nuxt-link>
