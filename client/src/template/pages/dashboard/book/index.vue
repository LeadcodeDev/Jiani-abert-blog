		...
		<div class="px-8 mt-6">
			<div v-for="(book, key) in books" class="border px-4 py-3 w-full flex justify-between mb-4 shadow-sm rounded" :key="key">
				...
				<div class="flex flex-row">
					...
					<button @click.prevent="openModal(book.id)" class="bg-red-600 text-white mx-1 px-2 py-1 rounded-md hover:bg-red-500"><i class="icon-trash text-white-500 bg-red-500"></i></button>
				</div>
...
export default {
	...
	setup() {
		...
		return { books, handleDelete, openModal, closeModal, state }
	},
}
</script>
