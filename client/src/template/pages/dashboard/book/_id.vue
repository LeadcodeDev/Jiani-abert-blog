			...
			<div class="w-1/2 bg-orange-300 rounded shadow-lg p-8">
				...
				<form class="mb-4" action="/" method="post">
					<div class="flex flex-col mb-4 md:w-full">
						...
						<input class="border py-2 px-3 text-grey-darkest2 outline-none" type="text" id="first_name" v-model="label" />
					</div>
					<div class="flex flex-col mb-4 md:w-full text-center">
						...
						<textarea rows="5" class="border px-3 text-grey-darkest h-custom outline-none" id="email" v-model="description" />
					</div>
