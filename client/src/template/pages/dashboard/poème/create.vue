<template>
	<div class="">
		...
		<div class="flex items-center h-screen justify-center w-full bg-teal-lighter calculedVerticale">
			<div class="w-1/2 bg-blue-300 rounded shadow-lg p-8">
				...
				<form class="mb-4" action="/" method="post">
					...
					<div class="flex flex-col mb-4 md:w-full text-center">
						<label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="email">Contenu de mon poème</label>
						<textarea class="border py-2 px-3 text-grey-darkest" type="email" v-model="state.content" id="email" />
					</div>
				</form>
			</div>
		</div>
...
<script>
import { reactive, useContext } from '@nuxtjs/composition-api' // import de fonction, permet d'utiliser des hooks de vuejs3
