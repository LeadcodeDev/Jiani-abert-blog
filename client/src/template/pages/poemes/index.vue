	...
	<main class="min-h-screen py-5">
		...
		<div class="w-full justify-center mx-auto">
			<div class="w-2/3 mx-auto flex justify-center">
				<div class="bg-white px-4 py-3 flex mx-auto items-center justify-center border-t border-gray-200 sm:px-6">
					...
					<div class="hidden sm:flex-1 sm:flex sm:items-center mx-auto">
						<div class="pr-5">
